<template>
  ...
  <div class="row" style="margin-bottom: 40px;">
      ...
      <div class="col">
        <router-link to="/" style="width: 210px;">
          <img
            src="https://assets.myntassets.com/w_122,c_limit,fl_progressive,dpr_2.0/assets/images/2022/8/17/9e19d40a-6720-4d62-92e0-32cd1ee6bee91660744897243-Flats---Heels--3-.jpghttps://assets.myntassets.com/w_122,c_limit,fl_progressive,dpr_2.0/assets/images/2022/8/17/0e56c483-33e8-4ea5-bae0-96020b7b31401660744930158-Dinnerware---Kitchenware.jpg"
            alt="" style="width: 203px;">
        </router-link>
      </div>
      <div class="col">
