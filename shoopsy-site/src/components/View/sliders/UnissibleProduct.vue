        ...
        <div class="col" style="">
          <router-link to="/" >
            <img
              ...
              alt="" style="width: 213px;margin-left:-22px;margin-right: 19px;">
          </router-link>
        </div>
        <div class="col" style="">
          <router-link to="/" >
            <img
              ...
              alt="" style="width: 213px;margin-left:-34px;margin-right: 40px;">
          </router-link>
        </div>
        <div class="col" style="">
          <router-link :to="{ name: 'Casual Shoes', params: { slug: 'Casual Shoes' } }" >
            <img
              ...
              alt="" style="width: 213px;margin-left:-67px;margin-right: 20px;">
          </router-link>
        </div>
        <div class="col" style="">
          <router-link to="/" >
            <img
              ...
              alt="" style="width: 213px;margin-left:-49px;margin-right: 20px;">
          </router-link>
        </div>
        <div class="col" style="">
          <router-link to="/" >
            <img
              ...
              alt="" style="width: 213px;margin-left:-37px;margin-right: 20px;">
          </router-link>
        </div>
        <div class="col" style="">
          <router-link to="/" >
            <img
              ...
              alt="" style="width: 213px;margin-left:-36px;margin-right: 20px;">
          </router-link>
        </div>
